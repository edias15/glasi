...
<div class="relative bg-white overflow-hidden">
    <div class="max-w-7xl mx-auto">
            ...
            <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
                ...
                <div class="flex items-center justify-between w-full md:w-auto">
                    ...
                    <span class="sr-only">Workflow</span>
                        <img class="h-8 w-auto sm:h-10" src="http://siglacontabilidade.com.br/public/assets/siglalogo.png" />
                    </a>
        ...
        <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            ...
            <h1 class="text-4xl tracking-tight font-bold text-black sm:text-5xl md:text-6xl">
                <span class="block xl:inline">Sigla Contabilidade</span>
                {{ ' ' }}
                <span class="block text-4xl text-indigo-600 xl:inline">Compromisso e Confiança</span>
            </h1>
            <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                Há mais de 17 anos ajudando empresas a se destacarem no mercado. Cuidamos de área fiscal e contábil, para que você aproveite o seu tempo com o que é importante.
            </p>
    ...
    <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="https://images.unsplash.com/photo-1423666523292-b4…fHx8fGVufDB8fHx8&auto=format&fit=crop&w=2948&q=80" alt="" />
    </div>
</div>
</template>
